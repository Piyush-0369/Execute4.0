  ...
  return (
    <div className="min-h-screen bg-blue-100 flex flex-col text-black">
      ...
      <div className="flex-1 flex flex-col items-center pt-10">
        <h1 className="text-3xl font-bold mb-20 pt-90">Welcome</h1>
        <div className="bg-white bg-opacity-80 w-full max-w-lg rounded-full px-6 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md ${
              file ? "bg-black text-gray-100" : "bg-black text-gray-200"
            }`}
          >
        ...
        {response && (
          <div className="mt-4 p-4 bg-black shadow rounded text-black">
